...
def main() -> None:
    ...
    parser.add_argument(
        "--workspace-directory",
        type=str,
        help="Path to the workspace directory (default: ./workspace). Ensure the workspace exists!",
        default="./autogpt-workspace",
    )

    args = parser.parse_args()

    # Initialize memory
    cfg.workspace_path = args.workspace_directory
    # Initialize memory
